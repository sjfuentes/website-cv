  ...
  return (
    <>
      <div className="text-center sm:mb-10 md:mb-12 lg:mb-15 mb-10">
        <h1 className="title-font mb-2 text-3xl font-extrabold leading-10 tracking-tight sm:text-3xl sm:leading-none md:text-4xl lg:text-5xl sm:mb-2 md:mb-3 lg:mb-4">Languajes</h1>
